    ...
    <header style="background-color: rgb(1, 1, 38); color: white">
        <div class="nav container">
            ...
            <ul class="dast-blog">
                ...
                <li><a style="border-bottom: 4px solid rgb(2, 2, 159);" href="/blogs">Results</a></li>
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo $row->polling_unit_id; ?></td>
    ...
    <div class="post container" id="more">
        ...
        <div class="post-box food">
            <img src="https://media.istockphoto.com/id/468337336/photo/nigeria-election-ballot-box-for-collecting-votes.webp?b=1&s=170667a&w=0&k=20&c=pAHLlC60v_jCc9tlAX3BXQpnJZsNmvkh438m-11BxGY=" alt="" class="post-img">
