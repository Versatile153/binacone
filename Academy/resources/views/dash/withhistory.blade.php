...
<head>
    ...
    <title>Fervidbridge - Withdraw Log</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Fervidbridge - Withdraw Log">
    
    <meta itemprop="name" content="Fervidbridge - Withdraw Log">
    ...
    <meta property="og:url" content="https://app.fervidbridge.org/user/withdraw/history">
            ...
            <div class="row justify-content-center mt-2">
                ...
                <div class="col-md-12">
                    <div class="text-right mb-5">
                        <a href="https://app.fervidbridge.org/user/withdraw" class="btn btn-primary">Withdraw Now</a>
                    </div>
                </div>
            </div>
        </div>
